...
public class TutorialTileScript : MonoBehaviour {
    ...
    public void CheckArea()
    {
        ...
        } else if (rowIndex + 1 <= 2) //checking below tile
        {
        ...
        else if (colIndex - 1 >= 0) //checking to the left of tile
        {
        ...
        else if (colIndex + 1 <= 2) //checking to the right of tile
        {
        ...
        {
            StartCoroutine(gameManager.gameInstance.requiredItemsUI("Nowhere to move this tile to.", 3f));
        }
    }
}
